...
function getHourlyWeather() {
  const apiUrl =
    "https://api.open-meteo.com/v1/forecast?latitude=36.71&longitude=3&hourly=temperature_2m,relative_humidity_2m,precipitation_probability,cloud_cover&timezone=auto&forecast_days=1";
